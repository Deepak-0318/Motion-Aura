function shareArticle() {
    ...
    function updateBookmarkUI() {
        ...
        const isBookmarked = bookmarks.includes('why-brand-videos-fail.html');
    ...
    function toggleBookmark() {
        ...
        const index = bookmarks.indexOf('why-brand-videos-fail.html');
        if (index > -1) {
            bookmarks.splice(index, 1);
            showToast('Bookmark removed.');
        } else {
            bookmarks.push('why-brand-videos-fail.html');
